...
public class CompletedFragment extends Fragment implements Show_order.FilterableFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new OrderAdapter(filteredOrders, order ->
                Toast.makeText(getContext(), "Completed: " + order.getCropType(), Toast.LENGTH_SHORT).show());
    ...
    private void loadCompletedOrders() {
        ...
        repository.getCompletedOrders(new AgrofastRepository.DataCallback<List<Order>>() {
            @Override
            public void onSuccess(List<Order> orders) {
                ...
                if (allOrders.isEmpty()) {
                    ...
                    tvEmptyState.setText("No completed orders yet");
                } else {
            ...
            public void onError(String error) {
                ...
                DevLogger.logError("CompletedFragment load", error, null);
